...
<body>
 ...
 ControlToValidate="txtdecNosearch" ErrorMessage="أدخل رقم القرار" CssClass="alert-danger" ></asp:CompareValidator>
	   ...
	   <asp:Button 
         ...
         CssClass="btn btn-lg btn-info col-lg-2 float-left" OnClick="btnSearch_Click" />&nbsp; <asp:Label ID="lblSearch" runat="server" ></asp:Label>
       </div>
    <div></div></div><br />
       <div class="container-fluid">
         ...
         <asp:DataList ID="DataList1" runat="server" DataKeyField="decID" DataSourceID="sdsdecNO" BorderColor="Silver" 
            ...
            Width="80%" OnItemDataBound="DataList1_ItemDataBound">
			 <EditItemTemplate>
		 ...
		 قرار رقم: 
				 ...
				 <br />
				 ملف القرار:
                 <a href="#" onclick='window.open("///192.168.14.42/Decisions/UploadedDecisions/<%#Eval("decisionFile")%>");  return false'><i class="far fa-file-pdf fa-2x text-info" title="فتح الملف"></i> فتح الملف  </a>
                 <hr /> <asp:LinkButton ID="LinkButton1" runat="server" OnCommand="LinkButton1_Command"  >LinkButton</asp:LinkButton>
<%--                  <hr /><asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# string.Format(@"file://192.168.14.42\Decisions\UploadedDecisions\{0}",Eval("decisionFile")) %>'  Text='<%# Eval("decisionFile") %>' Target="_blank" ></asp:HyperLink>--%>
				...
				<asp:Button ID="btnDel" runat="server" OnClick="btnDel_Click" OnClientClick="return confirm('هل انت متأكد من المسح؟');" Text="حذف" CssClass="btn btn-danger" />
                             ...
                             <asp:LinkButton ID="LinkButton1" runat="server"  CommandArgument="\\192.168.14.42\Decisions\UploadedDecisions\no.3-2022.PDF" OnCommand="LinkButton1_Command">LinkButton</asp:LinkButton>
