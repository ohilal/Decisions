...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
         ...
         <div class="top bg-gradient-secondary card-header"><img class="icon " src="Images/numbersGlass.png" />
	   ...
	   <asp:TextBox ID="txtdecNosearch" runat="server" CssClass="form-control col-lg-6 col-sm-12 mt-3" placeholder="رقم القرار" required style="right: 0px; top: 0px"></asp:TextBox>
	   <br /> 
