...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <h1 class="text-center text-info h1">أحدث ما  تم نشره </h1>
...
<asp:GridView ID="gdvTotal" runat="server" AutoGenerateColumns="False" 
   ...
   OnSorting="gdvTotal_Sorting" 
    ...
    DataKeyNames="decID" OnRowDataBound="gdvTotal_RowDataBound">
                    ...
                    <Columns>
                        <asp:BoundField DataField="decID" HeaderText="decID" SortExpression="decNo" Visible="False"/>       
                        ...
                        <asp:TemplateField HeaderText="ملف القرار" SortExpression="decisionFile">
                            ...
                            <ItemTemplate>
                    <a href="#" onclick="window.open('UploadedDecisions/<%#Eval("decisionFile")%>')" ><i class="far fa-file-pdf fa-2x text-info" title="فتح الملف"></i>
                        <asp:Label ID="decTitleLabel" runat="server" Text='<%# Eval("decTitle") %>' />
                    </a>
                </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="decTitle" HeaderText="القرار" SortExpression="decTitle" Visible="False"  />
...
</div>                <asp:SqlDataSource ID="countsds" runat="server" 
